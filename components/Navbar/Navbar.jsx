...
const StyledWrapper = styled.div`
  ...
  .tab-main.active {
    background: linear-gradient(135deg, rgba(79, 141, 255, 0.22) 0%, rgba(123, 97, 255, 0.22) 100%);
    color: var(--text-primary);
    box-shadow: 0 0 0 1px rgba(123, 97, 255, 0.5), 0 4px 20px rgba(79, 141, 255, 0.12);
  }
  ...
  .tab-sub.active {
    background: linear-gradient(135deg, rgba(79, 141, 255, 0.25) 0%, rgba(123, 97, 255, 0.25) 100%);
    color: var(--text-primary);
