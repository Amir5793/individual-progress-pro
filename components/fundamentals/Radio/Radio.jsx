...
const Radio = ({values, size, name, checked}) => {
...
const StyledWrapper = styled.div`
  ...
  .radio-inputs .radio .name {
    ...
    font-weight: 500;
    font-family: inherit;
    background: linear-gradient(145deg, var(--sidebar), var(--sidebar-primary));
    box-shadow: inset 1px 1px 3px var(--text-primary),
      inset -1px -1px 3px var(--text-primary);
    transition: all 0.2s ease;
    overflow: hidden;
  }

  .radio-inputs .radio input:checked + .name {
    background: linear-gradient(145deg, var(--primary), var(--accent-blue));
    color: white;
    font-weight: 600;
  ...
  .radio-inputs .radio:hover .name {
    background: linear-gradient(145deg, var(--sidebar-primary-foreground), var(--accent-blue));
    transform: translateY(-1px);
    box-shadow: 4px 4px 8px rgba(0, 0, 0, 0.1),
      -4px -4px 8px var(--accent-purple);
  }
  ...
  .radio-inputs .radio input:checked + .name::after {
    ...
    rgba(59, 130, 246, 0.5),
    rgba(37, 99, 235, 0.5));
    -webkit-mask: linearGradient(#fff 0 0) content-box,
    linearGradient(#fff 0 0);
